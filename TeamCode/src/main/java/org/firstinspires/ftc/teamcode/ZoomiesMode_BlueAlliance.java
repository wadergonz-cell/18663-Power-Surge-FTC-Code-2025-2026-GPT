// File: TeamCode/src/main/java/org/firstinspires/ftc/teamcode/ZoomiesMode_BlueAlliance.java
...
public class ZoomiesMode_BlueAlliance extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        telemetry.addLine("D-pad: Shooter speed (⬆ high / ⬇ low)  |  LB: Auto-aim (Tag ID 20)");
        telemetry.update();
